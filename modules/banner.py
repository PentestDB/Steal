...
def infolist1():
    ...
    print (Fore.GREEN+" [*]"+Fore.BLUE+"  Develper : Blackhack474 exploit to day \n")
    time.sleep(0.1)
    print (Fore.GREEN+" [*]"+Fore.MAGENTA+"  My Github : https//github.com/blackhack474-doc\n")
    time.sleep(0.1)
    print (Fore.GREEN+" [*]"+Fore.CYAN+"  Telegram chat https//t.me/joinchat/Q4M_kqLYQD3b6sGj\n")
    time.sleep(0.1)
    try:
